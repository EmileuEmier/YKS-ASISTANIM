...
## Veri Kaynağı
Bu projede kullanılan üniversite ve bölüm verileri, [YÖK Atlas](https://yokatlas.yok.gov.tr/) platformundan alınmıştır. Projenin veri doğruluğu ve güncelliği için resmi veriler temel alınmıştır. Veriler 2025 yılları verileridir, verilerde hata olabilir önemli bilgiler için resmi kurumlara bakın.
